    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <AppBar position="fixed" open={open}>
        <Toolbar>
          ...
          <Typography>{user ? `${user.fname} ${user.lname}` : 'Guest'}</Typography>
          <IconButton>
            <Brightness4 />
          </IconButton>
          <IconButton onClick={handleNotificationsClick}> {/* Redirects to /notifications */}
            <Badge badgeContent={unreadCount} color="secondary"> {/* Shows notification count */}
              <NotificationsIcon /> {/* Icon for notifications */}
            </Badge>
          </IconButton>
          <IconButton>
            <ProfileIcon /> {/* Profile picture */}
          </IconButton>
        </Toolbar>
      </AppBar>
      <Drawer variant="permanent" open={open}>
        ...
        <List>
          <ListItem disablePadding sx={{ display: 'block' }}>
            <ListItemButton component={Link} to="/home"> {/* Navigate to /home */}
              <ListItemIcon>
                <DashboardIcon />
              </ListItemIcon>
          ...
          <ListItem disablePadding sx={{ display: 'block' }}>
            <ListItemButton component={Link} to="/profile"> {/* Navigate to /profile */}
              <ListItemIcon>
                <MyProfileIcon />
              </ListItemIcon>
          ...
          <ListItem disablePadding sx={{ display: 'block' }}>
            <ListItemButton component={Link} to="/reports"> {/* Navigate to /reports */}
              <ListItemIcon>
                <ReportIcon />
              </ListItemIcon>
          ...
          <ListItem disablePadding sx={{ display: 'block' }}>
            <ListItemButton component={Link} to="/tickets"> {/* Navigate to /tickets */}
              <ListItemIcon>
                <TicketsIcon />
              </ListItemIcon>
        ...
        <List>
          <ListItem disablePadding sx={{ display: 'block' }}>
            <ListItemButton component={Link} to="/settings"> {/* Navigate to /settings */}
              <ListItemIcon>
                <SettingsIcon />
              </ListItemIcon>
          ...
          <ListItem disablePadding sx={{ display: 'block' }}>
            <ListItemButton component={Link} to="/logout"> {/* Navigate to /logout */}
              <ListItemIcon>
                <LogoutIcon />
              </ListItemIcon>
